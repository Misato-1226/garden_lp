...
export const Faq = () => {
  return (
    <div className="xl:h-[80vh] bg-rose-800">
      <h1 className="text-center text-white font-semibold text-2xl md:text-4xl p-10 xl:p-14">
        FAQ
      </h1>
      <div className="xl:px-24 p-10">
        <Accordion type="single" collapsible className="bg-white">
          <AccordionItem value="item-1" className="px-5 py-2">
            <AccordionTrigger className="text-lg xl:text-xl">
              Do you have parking lots?
            </AccordionTrigger>
            <AccordionContent className="text-md xl:text-lg">
          ...
          <AccordionItem value="item-2" className="px-5 py-2">
            <AccordionTrigger className="text-lg xl:text-lg">
